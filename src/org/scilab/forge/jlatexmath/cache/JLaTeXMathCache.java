...
public final class JLaTeXMathCache {
     ...
     */
    public static int[] getCachedTeXFormulaDimensions(String f, int style, int type, int size, int inset, Integer fgcolor) throws ParseException  {
     ...
     */
    public static Object getCachedTeXFormula(String f, int style, int type, int size, int inset, Integer fgcolor) throws ParseException  {
     ...
     * @param inset the inset to add on the top, bottom, left and right
     */
    public static void removeCachedTeXFormula(String f, int style, int type, int size, int inset, Integer fgcolor) throws ParseException  {
     ...
     * @return the key in the map
     */
    public static Object paintCachedTeXFormula(String f, int style, int type, int size, int inset, Integer fgcolor, Canvas g) throws ParseException  {
        return paintCachedTeXFormula(new CachedTeXFormula(f, style, type, size, inset, fgcolor), g);
    }

    public static Object paintCachedTeXFormula(String f, int style, int size, int inset, Canvas g) throws ParseException  {
     ...
     * @return the key in the map
     */
    public static Object paintCachedTeXFormula(Object o, Canvas g) throws ParseException  {
        if (o == null || !(o instanceof CachedTeXFormula)) {
            return null;
        }
        CachedTeXFormula cached = (CachedTeXFormula) o;
     ...
     */
    public static Bitmap getCachedTeXFormulaImage(String f, int style, int type, int size, int inset, Integer fgcolor) throws ParseException {
    ...
    private static class CachedTeXFormula {
        ...
        CachedTeXFormula(String f, int style, int type, int size, int inset, Integer fgcolor) {
            this.f = f;
            this.style = style;
            this.type = type;
            this.size = size;
