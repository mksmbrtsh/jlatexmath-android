...
## About
I find <http://forge.scilab.org/index.php/p/jlatexmath/page/GSOC-2014> and think, why not?
Android JLaTeXMath is an fork with a lot of modifications to support <http://forge.scilab.org/index.php/p/jlatexmath> in Android OS.<br>
